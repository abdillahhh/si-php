...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="images/bps.png">
    <title><?= $title; ?></title>
</head>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="images/1.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle" />
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="images/1.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3" />
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        John Pierce
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link" data-toggle="dropdown" href="#"><?= session('fullname'); ?><i
                            class="right fas fa-angle-down" style="margin-left: 10px"></i> </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-md">
                        ...
                        <form action="<?= base_url('/switchLevel') ?>" method="POST">
                            ...
                            <button type="submit"
                                class="dropdown-item roles <?= ($list['id'] == session('level_id')) ? 'aktif' : '' ?>"><?= $list['nama_level']; ?></button>
                        </form>
                        <?php endforeach; ?>
                        <div class="dropdown-divider"></div>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #3c4b64;">
            ...
            <a href=" <?= base_url('/dashboard') ?>" class="brand-link" style="border: none">
                <img src="<?= base_url('images/BPS.png') ?>" alt="Logo BPS" class="brand-image image-circle"
                    style="opacity: 0.8" />
