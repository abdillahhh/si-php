                ...
                <div class="row containers">
                    <div class="col-md-6 p-5">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/siphp/login" method="post">
                                ...
                                <button type="submit" id="liveAlertBtn"
                                    class="w-100 btn button mt-3 fw-semibold">Login</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-md-6 test2">
                        <img src="<?= base_url('/images/1.png')?>" class="card-img" style="object-fit: cover;"
                            height="100%">
                    </div>
                </div>
            </div>
