                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data" id="roleForm"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div>
                                                ...
                                                <button type="button" id="cancel" class="btn btn-danger btn-sm"><i
                                                        class="fas fa-times"></i></button>
                                            </div>
                                        </div>

                                    </form>
                                    <button id="openRole" class="btn btn-info btn-sm tombol"
                    ...
                    <div class="row mb-3">
                        ...
                        <form class="col-md-6">
                            <div class="input-group">
                                ...
                                <a href="<?= base_url('/tambahUser') ?>" class="btn btn-info tombol"
